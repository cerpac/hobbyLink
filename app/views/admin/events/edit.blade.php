...
@section('content')
    ...
    <h2>Modifica eveniment</h2>
 
    {{ Form::model($event, array('method' => 'put', 'route' => array('admin.events.update', $event->id), 'files' => true, 'class' => 'form-horizontal')) }}
		...
		<div class="form-group">
			<div class="col-lg-offset-3 col-lg-9">
				{{ Form::submit('Salveaza', array('class' => 'btn btn-success btn-large')) }}
