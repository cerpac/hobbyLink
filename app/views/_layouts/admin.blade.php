            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-1">
                        ...
                        <img src="{{ asset('assets/img/hobbyLink-logo-small.png') }}" />
                    ...
                    <div class="col-lg-5">
                        ...
                        @if (Sentry::check() && Sentry::getUser()->hasAccess('admin'))
                            ...
                            <div class="admin-box-top">
                                ...
                                <strong>Hobby Link Admin</strong>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        ...
                        <ul class="default-menu">
                            ...
                            <li class="{{ (Route::is('event.list') or Route::is('event')) ? 'active' : null }}"><a href="{{ route('event.list') }}">Events</a></li>
